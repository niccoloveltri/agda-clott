...
most one clock. The types of \GTT\ include the aformentioned \IC{▻} modality and a
\IC{□}  modality, the nameless analogue of  Atkey and
McBride's universal clock quantification.
\NV{Explain how is this different from Clouston et al.'s type theory}
