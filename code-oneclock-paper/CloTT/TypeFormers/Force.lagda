...
Hence, in order to construct an inhabitant of \AFi{Obj} \AB{A} \AB{i}, it suffices to find a size \AB{j} greater than \AB{i}.
Since \F{∞} is bigger than all sizes, we can define:
