...
as Coq, Agda, and Lean \cite{barras1997coq,de2015lean,norell}. It is a total language,
...
check is employed in Coq \cite{DBertotK08}.
This restriction
...
We discuss the meta-theory and recall sized types in \Cref{sec:prelim}.
Then we give the syntax of guarded recursive type theory \Cref{sec:syntax}.
In \Cref{sec:presheaf_sem,sec:guarded}, we define a denotational semantics of the syntax using sized types.  
