...
This definition is accepted by Agda's termination checker for two reasons: 1) every recursive call is applied to a strictly smaller size; 2) we use \F{SizeLt} in place of \F{Size<} in the definition of \F{Later}, preventing the above definition from unfolding indefinitely.
\remove{
