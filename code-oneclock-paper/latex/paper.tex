...
\cite{Mogelberg14}, where a (simple) type in a clock context
...
To interpret simple type theory, we also need to give the context operations, simple type formers, and operations on substitutions.
...
For example, the empty context is interpreted by the unit type and terminal presheaf depending on the clock context.
