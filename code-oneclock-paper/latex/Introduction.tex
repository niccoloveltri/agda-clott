...
\cite{Chapman09,AltenkirchK16}, we present an Agda formalization of
the syntax of a simple type theory with guarded recursion. This object
language, that we call \GTT, is a variant of Atkey and McBride's type
...
quantification. Clouston et al. \cite{CloustonBGB15} have studied a
...
also has the benefit of allowing a more pleasant introduction rule for
...
Abel and Vezzosi \cite{AbelV14} have also formalized a simple type theory
