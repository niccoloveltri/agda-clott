...
%\input{CloTT/Structure/ContextOperations} Context operations and simple type forrmers are not interesting. There is not much to tell about them, so a remark suffices.
