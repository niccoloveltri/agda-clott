...
\begin{abstract}
  ...
  these types are required to be productive to guarantee the
...
%%  finite unfoldings are guaranteed to produce . 
  ...
  recursion, corresponding to a variant of Atkey and McBride's
  calculus for productive coprogramming
...
The difficulty is representing coinductive types.
One could represent sizes by the conatural numbers, but this might not be sufficient to model infinitary coinductive types.
%%
%% Bibliography
%%
